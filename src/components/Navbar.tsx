                            ...
                            return (
                                <li key={ii}>
                                    <a
                                        ...
                                        title={item.label}
                                        className="font-medium tracking-wide text-neutral-400 transition-colors duration-200 hover:text-primary">
                                        {item.label}
                                    </a>
                                </li>
                            );
                                                ...
                                                return (
                                                    <li key={ii}>
                                                        <a
                                                            ...
                                                            title={item.label}
                                                            className="font-medium tracking-wide text-slate-400 transition-colors duration-200 hover:text-primary">
                                                            {item.label}
                                                        </a>
                                                    </li>
                                                );
